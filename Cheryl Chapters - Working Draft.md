# Cheryl Chapters — Working Draft

This file is for iterating on the Cheryl/cafeteria scenes. Starting from the current manuscript version (pre-Dog-Food-move).

## Current state

In the current manuscript:
- **Part 1 "You Look Like a Dork"** — Steve meets Cheryl but doesn't really listen. Walks out. ~50 lines.
- **Part 2 "The Dog Food Problem"** — Steve returns, hears the Dog Food story. Separate chapter.
- **Part 2 "The French Fry Revelation"** — Steve hears about small batches. Separate chapter.

## Decision

Clarke decided the Dog Food story should move into Part 1 — Steve hears it during his first visit, but leaves genuinely unconvinced rather than rude. His objection is genuine: "Nice story. Wrong industry." He can't bridge a kitchen and 47 million lines of code.

---

## You Look Like a Dork — Draft v1 (current manuscript)
