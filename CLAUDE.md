...
- `Session Log.md` — session-by-session log of all decisions and changes
...
## Rules
- Always update `Session Log.md` after every decision or change. Include timestamps (e.g. `### Thing I did (~14:30)`).
