...
### Part Two - Fresh Draft started (~afternoon)
- Decided to write Part Two fresh, chapter by chapter, rather than editing existing Working Draft
- Existing `Part Two - Working Draft.md` kept for comparison
- Created `Part Two - Fresh Draft.md` with first two chapters: Fowl Mood and Start Looking for a New Job
- Key changes from existing draft:
  - **Fowl Mood**: Added Darth napkin closing beat (Steve staring at napkin, "Darth stared back at him") - existing draft didn't have this
  - **Start Looking for a New Job**: Broke up Fran backstory into shorter movements, italicised *In Wyxcomb, we look after our own*
  - Added *her* printer emphasis
- Clarke reviewed and left inline comments. Fixes made:
  - Gregor now says "Taking the blame is just part of my job" aloud (was only narrated before, so Steve's response didn't make sense)
  - Replaced confusing "His words hurt because he knew how much they'd cost" with "If Norbert couldn't protect him, nobody could"
  - Removed "So Craig had kept his promise" - no matching promise in Downsized Part One
  - Clarke added "You've played the standard playbook, and it's not working" to Norbert's speech
  - Clarke added "Fresh eyes" / "Ah ha" exchange
- **Comparison verdict**: Fresh draft is better - tighter emotional beats, Darth callback, better paragraph rhythm. Not dramatically better but better in ways that matter for this book.
- **Workflow agreed**: Write fresh chapter by chapter. I draft, Clarke edits and comments, we iterate, then move on.

### Major restructure: timeline fix and new scene (~afternoon, continued)
- Clarke spotted timing problems: Cheryl wouldn't be in the kitchen at 5pm (she starts early for breakfast), and the wedding subplot doesn't earn its keep in Downsized
- **Restructured timeline:**
  - Wednesday afternoon: Ten Minutes is now phone-only. Craig says "I can't meet today, meet me tomorrow at 9 with Cheryl." Asks about the binder.
  - Wednesday ~5pm: **NEW CHAPTER - "Clearing the Road"** - Steve doesn't wait for Craig. Calls his PMs before they leave, puts 3 projects on notice for scaling back. Calls Gregor, who asks for 2 extra PMs and suggests Vrinda pull in analysts. Gregor has names ready. Steve is doing what any good leader would: clearing the road for the VIP project. ("The Motorcade Method" is Clarke's umbrella term for the whole book's approach.)
  - Thursday 9am: French Fry Revelation now happens at 9am, Cheryl is in her kitchen (timing works). Steve drops the binder on the table.
  - Thursday morning: Requirements chapter follows. Craig leaves - on holiday from Friday, three weeks away. No wedding.
- **Other fixes in this pass:**
  - Steve no longer apologises to Craig (their Part One parting was fine)
  - "The cloud we drew" → "That diagram we drew - Darth" (Part One never uses "cloud")
  - "Folder" → "binder" throughout. Phil and Vrinda insist on a physical copy for the big picture.
  - Wedding references removed entirely. Craig is just on holiday.
  - Small batches gag updated: "You said that yesterday" / "And have you been thinking about them?"
  - Cigar callback adjusted for day change: "Or was it yesterday? The days were blurring together."
- Ready for Clarke's review and comments.

### Removed all git references (~morning)
- Cleaned Session Log.md of commit hashes, "### Commits" sections, push/pull references
- Clarke deleted .gitignore manually
- Project is now clean markdown files only, synced via Obsidian Sync
...
- Added rule: always update Session Log after every decision or change
...
- Reverted manuscript to pre-Dog-Food state
